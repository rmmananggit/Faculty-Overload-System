    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <h5 class="card-title">Personal Data</h5>
          ...
          <form class="row g-3 needs-validation" method="POST" action="./controller/staff-edit.php" novalidate>
          ...
          <label for="emailAddress" class="form-floating"></label>
            ...
            <div class="col-12">
              ...
              <a href="hr.php" class="btn btn-secondary me-2" role="button">Cancel</a>
                <button class="btn btn-primary" type="submit" name="staffEdit">Save</button>
              </div>
          </div>
